...
[ML Config](../databricks_mlops_stacks/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore databricks_mlops_stacks/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [databricks-mlops-stacks/databricks.yml](../databricks_mlops_stacks/databricks.yml)
and [databricks-mlops-stacks/assets/ml-artifacts-asset.yml](../databricks_mlops_stacks/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [databricks-mlops-stacks/assets/README.md](../databricks_mlops_stacks/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../databricks_mlops_stacks/assets/README.md)  to propose, test, and deploy
