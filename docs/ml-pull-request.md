...
Opening a pull request will trigger a[workflow](../.github/workflows/databricks-mlops-stacks-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-databricks-mlops-stacks-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-databricks-mlops-stacks-model)
