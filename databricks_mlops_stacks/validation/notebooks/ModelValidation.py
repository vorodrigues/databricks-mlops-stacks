...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``databricks_mlops_stacks/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in databricks-mlops-stacks/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in databricks-mlops-stacks/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-databricks-mlops-stacks-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.vr_mlops_stacks.databricks-mlops-stacks-model", "Full (Three-Level) Model Name")
